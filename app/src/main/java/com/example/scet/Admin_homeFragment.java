...
public class Admin_homeFragment extends Fragment {
     ...
     * @return A new instance of fragment Admin_homeFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CardView cvpackage = view.findViewById(R.id.cvpackage);
        CardView cvorder = view.findViewById(R.id.cvorder);
        ...
        cvpackage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), Adminpackage.class));
            }
        });
        cvuser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(),Adminuser.class));
            }
        });
        cvorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(),Adminorder.class));
            }
        });
    }
}